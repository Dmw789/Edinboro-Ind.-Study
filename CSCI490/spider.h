...
//*****PUBLIC METHODS*****
	...
	//*****CONSTRUCTORS*****
	Spider(string name);
	//Narrative: Parameterized constructor for the Spider class. Takes a name and creates a new instance of the class with
	...
	//
	//Post-condition: A new instance of Spider is created.
	//
...
//*****PRIVATE METHODS*****
	...
	//*****CONSTRUCTORS*****
	Spider();
	//Narrative: A private constructor for the Spider class. Set to private and should never be called. 
	//
	//Pre-condition: none
	//
