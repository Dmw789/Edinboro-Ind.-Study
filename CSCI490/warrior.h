...
//*****PUBLIC METHODS*****
	...
	Warrior(string name);
	//Narrative: Parameterized constructor for the Warrior class. Takes a name and creates a new instance of the class with
	...
	//
	//Post-condition: A new instance of Warrior is created.
	//
...
//*****PRIVATE METHODS*****
	...
	Warrior();
	//Narrative: A private constructor for the Warrior class. Set to private and should never be called. 
	//
	//Pre-condition: none
	//
