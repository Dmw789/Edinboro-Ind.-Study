...
//*****PUBLIC METHODS*****
	...
	Hornet(string name);
	//Narrative: Parameterized constructor for the Hornet class. Takes a name and creates a new instance of the class with
	...
	//
	//Post-condition: A new instance of Hornet is created.
	//	
...
//*****PRIVATE METHODS*****
	...
	Hornet();
	//Narrative: A private constructor for the Hornet class. Set to private and should never be called. 
	//
	//Pre-condition: none
	//
